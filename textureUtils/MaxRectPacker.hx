...
class MaxRectPacker
{
	...
	inline private function quickFindPositionForNewNodeBestAreaFit(width:Float, height:Float):Rectangle {
	...
	inline private function isContainedIn(a:Rectangle, b:Rectangle):Bool {
